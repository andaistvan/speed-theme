...
<!-- TAB UL -->
   <ul class="tabs" data-tabs id="myaccount-tabs">
     <li class="tabs-title is-active"><a href="#panel1" aria-selected="true">bejelentkezés</a></li>
     <li class="tabs-title"><a href="#panel2">regisztráció</a></li>
   </ul>
<!-- TAB UL -->

   <div class="tabs-content" data-tabs-content="myaccount-tabs">
   ...
   <div class="tabs-panel" id="panel2">
		<h5 id="registration"><?php _e('Register', 'woocommerce'); ?></h5>
