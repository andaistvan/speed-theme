...
.pho-upgrade-btn a {
    ...
    margin-top: 75px;
       ...
       <div class="premium-box-container">
            ...
            <div class="pho-desc-head"><h2>Add Custom Registration Fields</h2></div>
            <div class="pho-plugin-content">
                        <p>
								 You can create your own custom registration fields like <b>Name</b>, <b>user name</b>, <b>date of birth</b>, <b>address</b>,

</b>contact number</b> by using field types like <b>text box</b>, <b>text area</b>, <b>drop own</b>, <b>date</b>, <b>check box</b>, <b>radio button</b>.

You can make the fields mandatory, can show label filled in the Field placeholder.</p>
                        <div class="pho-img-bg">
                        <img src="<?php echo $plugin_dir_url; ?>images/feature.png" />
                        </div>
                    </div>
