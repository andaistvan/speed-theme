...
function sf_register_settings() {
	...
	add_settings_field('sf_iconbar', "Iconbar mode", 'sf_iconbar_str', 'sf', 'sf_appearance');
	...
	add_settings_field('sf_sub_type', "Use mobile logic for submenus on desktops", 'sf_sub_type_str', 'sf', 'sf_appearance');
	...
	add_settings_field('sf_fade_full', "Overlay color in fullscreen mode:", 'sf_fade_full_str', 'sf', 'sf_appearance');
	...
	add_settings_field('sf_image_bg', "Custom background image", 'sf_image_bg_str', 'sf', 'sf_appearance');
	...
	add_settings_field('sf_chapter_1', "Chapter text color in first level", 'sf_chapter_1_str', 'sf', 'sf_appearance');
	add_settings_field('sf_chapter_2', "Chapter text color in second level", 'sf_chapter_2_str', 'sf', 'sf_appearance');
	add_settings_field('sf_chapter_3', "Chapter text color in third level", 'sf_chapter_3_str', 'sf', 'sf_appearance');
	add_settings_field('sf_chapter_4', "Chapter text color in forth level", 'sf_chapter_4_str', 'sf', 'sf_appearance');
	...
	add_settings_field('sf_linkedin', "Linkedin URL", 'sf_linkedin_str', 'sf', 'sf_appearance');
	add_settings_field('sf_social_color', "Color of social icons", 'sf_social_color_str', 'sf', 'sf_appearance');
    add_settings_field('sf_copy', "Copyright text", 'sf_copy_str', 'sf', 'sf_appearance');
...
//	add_settings_field('sf_lh', "Line-height of menu item:", 'sf_lh_str', 'sf', 'sf_menu_items');
    ...
    add_settings_field('sf_c_fs', "", 'sf_c_fs_str', 'sf', 'sf_menu_items', array('chapter' => 'Section headers styling'));
	...
	add_settings_field('sf_fixed', "Button fixed on page", 'sf_fixed_str', 'sf', 'sf_label');
	...
	add_settings_field('sf_label_width', "Icon lines width", 'sf_label_width_str', 'sf', 'sf_label');
...
function sf_display_str() {
	...
	?>
	<h6>Control plugin displaying with next set of rules.</h6>
	<p>
...
function sf_scolor_panel_4_str() {
	...
	echo "<h6>Chapter headings are added in <a href='/wp-admin/nav-menus.php'>Appearance/Menus</a>.</h6><input id='sf_chapter_1' data-color-format='hex' name='sf_options[sf_chapter_1]' type='text' value='{$options['sf_chapter_1']}' style='' />
		<script>
...
function sf_image_bg_str () {
	$options = sf_get_options();
	echo "<h6>Select custom background image for main Superfly sidebar from your WP media library.</h6>
...
function sf_sidebar_style_str() {
    ...
    <option value='static' " . ($type === 'static' ? 'selected="selected"' : '') . ">Always visible on page (with iconbar option)</option>
    <option value='full' " . ($type === 'full' ? 'selected="selected"' : '') . "> Fullscreen overlay</option>
    </select>
    <h6 style='margin-top:5px' data-notice='static'> Always visible option requires body padding so is not compatible with fixed width themes in most cases</h6>
    ";
...
function sf_opening_type_str() {
    ...
    <option value='hover' " . ($size === 'hover' ? 'selected="selected"' : '') . ">On mouseover of button and screen edge </option>
...
function sf_c_fs_str() {
	$options = sf_get_options();
    echo "<h6>Font settings for chapter headings. You can set up chapters on <a href='/wp-admin/nav-menus.php'>Appearance/Menus</a> page.</h6>";
	echo " <input id='sf_c_fs' name='sf_options[sf_c_fs]' size='2' type='text' value='{$options['sf_c_fs']}' style='' /><span style='margin: 0 15px 0 5px'>px</span>";
}
...
function sf_label_width_str() {
	$options = sf_get_options();
	echo "
	 <input id='sf_label_width' name='sf_options[sf_label_width]' size='1' type='text' value='{$options['sf_label_width']}' style='' /> px";
}
...
function sf_blur_content_str () {
    ...
    $sec_checked = $options['sf_blur_content'] == 'none' ? 'checked="checked"' : '';
	  ...
	  echo "<h6>When sidebar is exposed and if browser supports this CSS filter.</h6>";
...
function sf_linkedin_str() {
	...
	$options = sf_get_options();
	echo " <input id='sf_copy' name='sf_options[sf_copy]' size='100' type='text' value='{$options['sf_copy']}' style='' />";
}
