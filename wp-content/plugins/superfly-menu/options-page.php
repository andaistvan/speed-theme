...
function custom_do_settings_fields($page, $section) {
	...
	foreach ( (array) $wp_settings_fields[$page][$section] as $field ) {
		...
		if ( !empty($field['args']['label_for']) ) {
			...
			echo '<p class="field-title">' . $field['title'] . '</p>';
		}
...
screen_icon();
?>
<h2 class="form-title"><img src="<?php echo plugins_url('/img/', __FILE__); ?>logo.png" alt="" target="_blank"> Superfly <?php echo SF_VERSION_NUM ?> Settings  </h2>
