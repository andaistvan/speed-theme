...
if (!class_exists('YITH_Category_Accordion_Widget')) {
    class YITH_Category_Accordion_Widget extends  WP_Widget
    {
        ...
        public function widget($args, $instance)
        {
            ...
            echo '<h2 class="ywcca_widget_title">'.$instance['title'].'</h2>';
        ...
        public function form($instance)
        {
            ...
            ?>"><?php _e('Title', 'yith-woocommerce-category-accordion');
            ?></label>
                <input class="widefat" type="text" id="<?php echo $this->get_field_id('title');
            ?>" name="<?php echo $this->get_field_name('title');
            ?>" placeholder="<?php _e('Insert a title for the accordion menu', 'yith-woocommerce-category-accordion');
            ?>" value="<?php echo $instance['title'];
            ?>">
            </p>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('show_wc_cat'));
            ?>"><?php _e('Show WooCommerce Categories', 'yith-woocommerce-category-accordion');
            ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('show_wc_subcat'));
            ?>"><?php _e('Show WooCommerce Subcategories', 'yith-woocommerce-category-accordion');
            ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('show_wp_cat'));
            ?>"><?php _e('Show WordPress Categories', 'yith-woocommerce-category-accordion');
            ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('show_wp_subcat'));
            ?>"><?php _e('Show WordPress Subcategories', 'yith-woocommerce-category-accordion');
            ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('highlight_curr_cat'));
            ?>"><?php _e('Highlight the current category', 'yith-woocommerce-category-accordion');
            ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('show_collapse'));
            ?>"><?php _e('Closed accordion', 'yith-woocommerce-category-accordion');
            ?></label>
